...
// This creates each list and then puts them into nLists
idxZero = createList([1, 5, 7]);
idxOne = createList([1, 2, 4, 8]);
idxTwo = createList([3, 6, 8]);
nLists = [idxZero, idxOne, idxTwo];